  ...
  return (
    <>
      ...
      {!!plan.openForAdmission && (
        <div className="text-left mb-6 space-y-2 p-1 px-2 bg-[rgb(var(--accent))] rounded-md shadow-inner">
          <p className="text-sm  font-normal text-[rgb(var(--primary-text))]">
            Seats Left:
            <span
      ...
      <div className="text-center mb-6">
        {plan.discountedPrice && plan.discountedPrice < plan.price ? (
          <>
            ...
            <p className="text-xl font-bold text-[rgb(var(--muted-foreground))] line-through">
              ₹ {plan.price}
            </p>
          </>
        ) : (
